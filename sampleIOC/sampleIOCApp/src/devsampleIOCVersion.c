...
#include "sampleIOCVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = sampleIOCVERSION;
...
static lsidset devsampleIOCVersion = {
	{5, NULL, NULL, NULL, NULL}, read_string
};
epicsExportAddress(dset,devsampleIOCVersion);
