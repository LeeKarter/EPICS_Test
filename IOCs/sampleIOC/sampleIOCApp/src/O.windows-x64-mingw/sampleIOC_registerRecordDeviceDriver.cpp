...
/* Generated from ../O.Common/sampleIOC.dbd */
...
epicsShareExtern typed_rset *pvar_rset_aSubRSET, *pvar_rset_aaiRSET,
    ...
    *pvar_rset_waveformRSET, *pvar_rset_xxxRSET;
...
epicsShareExtern rso_func pvar_func_aSubRecordSizeOffset,
    ...
    pvar_func_waveformRecordSizeOffset, pvar_func_xxxRecordSizeOffset;
...
static const recordTypeLocation rtl[] = {
    ...
    {(struct typed_rset *)pvar_rset_xxxRSET, pvar_func_xxxRecordSizeOffset}
};
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_asynLsiOctetRead, *pvar_dset_devsampleIOCVersion,
    ...
    *pvar_dset_devWfSoft, *pvar_dset_devwaveformStream,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynLsiOctetRead", "devsampleIOCVersion", "devLsoSoft",
    ...
    "devSiGeneralTime", "devSiEnviron", "devstringinStream",
    "asynSiOctetCmdResponse", "asynSiOctetWriteRead", "asynSiOctetRead",
    "devSoSoft", "devSoSoftCallback", "devSoStdio", "devstringoutStream",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devsampleIOCVersion, pvar_dset_devLsoSoft,
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_drvAsynSerialPortRegisterCommands, pvar_func_helloRegister,
    pvar_func_initTraceRegister, pvar_func_installPVAAddLinkHook,
...
int sampleIOC_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/LeeKarter/IOCs/sampleIOC";
    ...
    runRegistrarOnce(pvar_func_helloRegister);
    runRegistrarOnce(pvar_func_initTraceRegister);
    ...
    runRegistrarOnce(pvar_func_register_func_myAsubInit);
    runRegistrarOnce(pvar_func_register_func_myAsubProcess);
    runRegistrarOnce(pvar_func_register_func_mySubInit);
    runRegistrarOnce(pvar_func_register_func_mySubProcess);
    iocshRegisterVariable(vardefs);
    return 0;
}

/* sampleIOC_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: sampleIOC_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(sampleIOC_registerRecordDeviceDriver(*iocshPpdbbase));
}
